...
usage_tags: [design,ui,visual,branding,osterwalder-canvas-architect,design]
cost_badge: FREE
always_load: false
source_repo: https://github.com/sickn33/antigravity-awesome-skills
source_skill_path: plugins/antigravity-awesome-skills-claude/skills/osterwalder-canvas-architect/SKILL.md
