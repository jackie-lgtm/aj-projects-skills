...
usage_tags: [design,ui,visual,branding,figma-create-design-system-rules,design]
cost_badge: OAUTH
always_load: false
source_repo: https://github.com/figma/mcp-server-guide
source_skill_path: skills/figma-create-design-system-rules/SKILL.md
