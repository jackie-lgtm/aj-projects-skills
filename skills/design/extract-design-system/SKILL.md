...
usage_tags: [design,ui,visual,branding,extract-design-system,design]
cost_badge: FREE
always_load: false
source_repo: https://github.com/arvindrk/extract-design-system
source_skill_path: skills/extract-design-system/SKILL.md
