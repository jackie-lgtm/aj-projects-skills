...
usage_tags: [sales,outreach,pipeline,crm,cross-functional-collaboration,sales]
cost_badge: OAUTH
always_load: false
source_repo: https://github.com/refoundai/lenny-skills
source_skill_path: skills/cross-functional-collaboration/SKILL.md
