...
usage_tags: [sales,outreach,pipeline,crm,sales-social-media-management,sales]
cost_badge: OAUTH
always_load: false
source_repo: https://github.com/sales-skills/sales
source_skill_path: skills/sales-social-media-management/SKILL.md
