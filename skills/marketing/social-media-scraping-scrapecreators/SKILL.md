...
usage_tags: [marketing,content,copy,growth,social-media-scraping-scrapecreators,marketing]
cost_badge: FREE
always_load: false
source_repo: https://github.com/athina-ai/goose-skills
source_skill_path: skills/capabilities/social-media-scraping-scrapecreators/SKILL.md
