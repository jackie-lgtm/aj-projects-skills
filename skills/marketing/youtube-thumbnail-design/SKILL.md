...
usage_tags: [marketing,content,copy,growth,youtube-thumbnail-design,marketing]
cost_badge: FREEMIUM
always_load: false
source_repo: https://github.com/inferen-sh/skills
source_skill_path: guides/design/youtube-thumbnail-design/SKILL.md
