...
usage_tags: [marketing,content,copy,growth,odoo-upgrade-advisor,marketing]
cost_badge: FREE
always_load: false
source_repo: https://github.com/sickn33/antigravity-awesome-skills
source_skill_path: plugins/antigravity-awesome-skills-claude/skills/odoo-upgrade-advisor/SKILL.md
