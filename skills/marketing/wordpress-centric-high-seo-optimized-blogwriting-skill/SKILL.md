...
usage_tags: [marketing,content,copy,growth,wordpress-centric-high-seo-optimized-blogwriting-skill,marketing]
cost_badge: FREE
always_load: false
source_repo: https://github.com/sickn33/antigravity-awesome-skills
source_skill_path: plugins/antigravity-awesome-skills-claude/skills/wordpress-centric-high-seo-optimized-blogwriting-skill/SKILL.md
