...
description: ">"
usage_tags: [marketing,content,copy,growth,get-qualified-leads-from-luma,marketing]
cost_badge: FREE
always_load: false
source_repo: https://github.com/athina-ai/goose-skills
source_skill_path: skills/composites/get-qualified-leads-from-luma/SKILL.md
