...
usage_tags: [automation,workflow,integration,apify-generate-output-schema,automation]
cost_badge: FREEMIUM
always_load: false
source_repo: https://github.com/apify/agent-skills
source_skill_path: skills/apify-generate-output-schema/SKILL.md
