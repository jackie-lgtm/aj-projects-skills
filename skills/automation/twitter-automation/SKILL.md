...
usage_tags: [automation,workflow,integration,twitter-automation,automation]
cost_badge: FREE
always_load: false
source_repo: https://github.com/sickn33/antigravity-awesome-skills
source_skill_path: plugins/antigravity-awesome-skills-claude/skills/twitter-automation/SKILL.md
