...
usage_tags: [automation,workflow,integration,n8n-node-configuration,automation]
cost_badge: BYO-API
always_load: false
source_repo: https://github.com/czlonkowski/n8n-skills
source_skill_path: skills/n8n-node-configuration/SKILL.md
